...
if TYPE_CHECKING:
    from boardfarm_api.ai_engine.codegen import PromptRegistry


def register_to(registry: PromptRegistry)->None:
    """Register all standard-variant pytest prompts."""
    from boardfarm_api.ai_engine.codegen import (
        CodegenOutputType as Output,
    )
    from boardfarm_api.ai_engine.codegen import CodegenPromptPair
    from boardfarm_api.ai_engine.codegen import (
    ...
    _V = Variant.COMPACT_SMALL_MODELS
    _O = Output.PYTEST
