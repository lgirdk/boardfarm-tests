...
If you are about to create a setup_teardown fixture, verify: does the 
test actually modify persistent state? If the only "cleanup" is stopping 
a process that was started with a context manager (with statement), the 
with-block already handles it — delete the fixture."""
