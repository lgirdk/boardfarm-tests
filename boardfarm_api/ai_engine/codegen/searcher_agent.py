...
if TYPE_CHECKING:
    from boardfarm_api.ai_engine.search_store.custome_types import CorpusHits
    from boardfarm_api.ai_engine.search_store.data_models import ResolvedIndexStubEntry
