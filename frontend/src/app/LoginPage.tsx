...
export function LoginPage() {
  ...
  return (
    <div className="flex h-screen items-center justify-center bg-canvas bg-dotgrid px-4">
      <div className="glow-ambient w-full max-w-sm rounded-[12px] border border-border bg-surface p-6">
        <div className="flex items-center gap-2.5">
          <div className="flex h-7 w-7 items-center justify-center rounded-md bg-brand-gradient">
            <FlaskConical className="h-4 w-4 text-accent-fg" />
          </div>
          <span className="text-brand text-[16px] font-semibold tracking-tight">
            Boardfarm
          </span>
        </div>
        <p className="mt-1.5 text-xs text-muted">
          One place to browse, generate, run, and analyze boardfarm tests. Sign in to
          your workspace.
        </p>
