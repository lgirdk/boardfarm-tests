...
/**
 * The greeting banner — extracted so AppShell can render it above the launcher
 * tiles on the home page. Reads live data from auth + beds.
 */
          ...
          <div className="space-y-6">
            <section>
              <div className="flex items-baseline justify-between">
                ...
                <Link to="/lab" className="text-[11.5px] text-highlight hover:underline">
                  Board map
                </Link>
              </div>
