...
export class MockAppsClient implements AppsClient {
  ...
  async resolveJiraPlan(planKey: string): Promise<JiraPlanResolution> {
    await delay(500);
    return {
      key: planKey.trim().toUpperCase() || "MVX-R22-EXIT",
      issues: structuredClone(MOCK_PLAN_ISSUES),
    };
  }
}
...
/* A Jira test plan resolved to library tests (mock). Two issues have no test. */
const MOCK_PLAN_ISSUES: JiraPlanResolution["issues"] = [
  { key: "MVX_TST-1985", summary: "LLC filter behaviour for IPv6 eRouter", test: "test_MVX_TST_1985" },
  { key: "MVX_TST-1204", summary: "CM reaches online after boot", test: "test_cm_status_online" },
  { key: "MVX_TST-1660", summary: "FXS-to-FXS voice call", test: "test_voice_call_fxs_to_fxs" },
  { key: "MVX_TST-1902", summary: "WAN IPv4 survives reboot", test: "test_wan_ipv4_after_reboot" },
  { key: "MVX_TST-2011", summary: "LAN client DNS resolution", test: "test_dns_resolution_lan_client" },
  { key: "MVX_TST-2041", summary: "LLC filter IPv6 variant", test: null },
  { key: "MVX_TST-2088", summary: "Three-way conference on FXS lines", test: null },
];
